...
from tests.remote_fakes import FakeApplication, FakeSong, FakeTrack, FakeClipSlot, FakeClip
...
def test_get_composition_structure() -> None:
    ...
    assert "track:3" in res["unnamed_tracks"]  # Master is track:3 (Bass:0, Return A:1, Lead:2, Master:3)
